 ...
 */
export function coerceRequiredString(value, fieldName) {
 ...
 */
function getNormalizedPhoneNumber(payload) {
 ...
 */
function resolveIsActive(payload) {
 ...
 */
export async function buildUserCreateData(payload) {
    const username = coerceRequiredString(payload.username, "username");
    const phoneNumber = coerceRequiredString(getNormalizedPhoneNumber(payload), "phone number");
 ...
 */
export async function buildUserUpdateData(payload) {
    const data = {};
    ...
    if (payload.phone !== undefined || payload.phoneNumber !== undefined) {
        data.phoneNumber = coerceRequiredString(getNormalizedPhoneNumber(payload), "phone number");
    }
    if (payload.roleId !== undefined) {
        data.roleId = coerceNullableString(payload.roleId);
    }
    ...
    if (payload.password !== undefined) {
        data.password = await hashPassword(coerceRequiredString(payload.password, "password"));
    }
    return data;
}
/**
 ...
 */
export async function syncUser(tx, params) {
    if (params.userId) {
