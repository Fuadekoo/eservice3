...
try {
  ...
  app.get("/back-api/api-docs.json", (_req: Request, res: Response) => {
    res.setHeader("Content-Type", "application/json");
    res.send(swaggerSpec);
  });
  ...
  console.log(
    "[App] ✅ Swagger UI available at /back-api/api-docs (production)",
  );
  console.log(
    "[App] ✅ Swagger JSON spec available at /api-docs.json and /back-api/api-docs.json",
  );
} catch (error) {
...
app.get("/test-swagger", (_req: Request, res: Response) => {
  res.json({
...
app.get("/back-api/health", (_req: Request, res: Response) => {
