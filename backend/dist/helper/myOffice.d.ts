...
export declare function hasOfficeWideAccess(roleName?: string | null, isAdmin?: boolean, isManager?: boolean): boolean;
export declare function requestHasOfficeWideAccess(req: AuthRequest): boolean;
export declare function roleRequiresOfficeAssignment(roleName?: string | null, isAdmin?: boolean, isManager?: boolean): boolean;
...
export declare function resolveStaffOfficeAssignment({ actorRoleName, actorIsAdmin, actorIsManager, actorOfficeId, requestedOfficeId, targetRoleName, }: ResolveOfficeAssignmentInput): Promise<string | null>;
...
export declare function hasCompanyWideWarehouseAccess(roleName?: string | null, isAdmin?: boolean, isManager?: boolean): boolean;
export declare function requestHasCompanyWideWarehouseAccess(req: AuthRequest): boolean;
export declare function roleRequiresWarehouseAssignment(roleName?: string | null, isAdmin?: boolean, isManager?: boolean): boolean;
...
export declare function resolveOfficerWarehouseAssignment({ actorRoleName, actorIsAdmin, actorIsManager, actorWarehouseId, actorOfficeId, requestedWarehouseId, requestedOfficeId, targetRoleName, }: ResolveOfficerWarehouseAssignmentInput): Promise<string | null>;
export {};
