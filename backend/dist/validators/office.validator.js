import { z } from "zod";
import { ETHIOPIAN_MOBILE_PHONE_MESSAGE, normalizeEthiopianMobilePhone, } from "../utils/phone.js";
const optionalOfficePhoneField = z
    .string()
    .trim()
    .refine((value) => value === "" || normalizeEthiopianMobilePhone(value) !== null, {
    message: ETHIOPIAN_MOBILE_PHONE_MESSAGE,
})
    .transform((value) => value === "" ? null : normalizeEthiopianMobilePhone(value))
    .optional()
    .nullable();
